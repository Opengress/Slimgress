...
import static com.norman0406.slimgress.API.Common.Utils.getImageBitmap;
...
//        ((TextView)findViewById(R.id.portalLevel)).setTextColor();
        ...
        // FIXME only do it for portals in radius
        findViewById(R.id.hackButton).setEnabled(true);
        findViewById(R.id.hackButton).setOnClickListener(v -> {
            // TODO: make the handler static and figure out what to do with it - needs callback (and maybe looper)
